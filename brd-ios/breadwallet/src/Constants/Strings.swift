...
enum S {
    ...
    enum Widget {
        ...
        enum Color {
            ...
            static let grayDark = NSLocalizedString("Widget.Color.grayDark", value: "Gray Dark", comment: "Name of color - Gray dark")
            static let grayLight = NSLocalizedString("Widget.Color.grayLight", value: "Gray Light", comment: "Name of color - Gray light")
            static let red = NSLocalizedString("Widget.Color.red", value: "Red", comment: "Name of color - Red")
            static let redAlt = NSLocalizedString("Widget.Color.redAlt", value: "Red Alternative", comment: "Name of color - Red alternative")
            static let redDark = NSLocalizedString("Widget.Color.redDark", value: "Red Dark", comment: "Name of color - Red dark")
            static let redLight = NSLocalizedString("Widget.Color.redLight", value: "Red Light", comment: "Name of color - Red light")
            static let green = NSLocalizedString("Widget.Color.green", value: "Green", comment: "Name of color - Green")
            static let greenAlt = NSLocalizedString("Widget.Color.greenAlt", value: "Green Alternative", comment: "Name of color - Green alternative")
            static let greenDark = NSLocalizedString("Widget.Color.greenDark", value: "Green Dark", comment: "Name of color - Green dark")
            static let greenLight = NSLocalizedString("Widget.Color.greenLight", value: "Green Light", comment: "Name of color - Green light")
            static let blue = NSLocalizedString("Widget.Color.blue", value: "Blue", comment: "Name of color - Blue")
            static let blueDark = NSLocalizedString("Widget.Color.blueDark", value: "Blue Dark", comment: "Name of color - Blue dark")
            static let blueLight = NSLocalizedString("Widget.Color.blueLight", value: "Blue Light", comment: "Name of color - Blue light")
            static let orange = NSLocalizedString("Widget.Color.orange", value: "Orange", comment: "Name of color - Orange")
            static let orangeDark = NSLocalizedString("Widget.Color.orangeDark", value: "Orange Dark", comment: "Name of color - Orange dark")
            static let orangeLight = NSLocalizedString("Widget.Color.orangeLight", value: "Orange Light", comment: "Name of color - Orange light")
            static let yellow = NSLocalizedString("Widget.Color.yellow", value: "Yellow", comment: "Name of color - Yellow")
            static let yellowDark = NSLocalizedString("Widget.Color.yellowDark", value: "Yellow Dark", comment: "Name of color - Yellow dark")
            static let yellowLight = NSLocalizedString("Widget.Color.yellowLight", value: "Yellow Light", comment: "Name of color - Yellow light")
            static let pink = NSLocalizedString("Widget.Color.pink", value: "Pink", comment: "Name of color - Pink")
            static let pinkDark = NSLocalizedString("Widget.Color.pinkDark", value: "Pink Dark", comment: "Name of color - Pink dark")
            static let pinkLight = NSLocalizedString("Widget.Color.pinkLight", value: "Pink Light", comment: "Name of color - Pink light")
            static let purple = NSLocalizedString("Widget.Color.purple", value: "Purple", comment: "Name of color - Purple")
            static let purpleDark = NSLocalizedString("Widget.Color.purpleDark", value: "Purple Dark", comment: "Name of color - Purple dark")
            static let purpleLight = NSLocalizedString("Widget.Color.purpleLight", value: "Purple Light", comment: "Name of color - Purple light")
    ...
    enum Exchange {
        ...
        enum ErrorState {
            ...
            static let insufficientNativeWalletBalance = NSLocalizedString("Exchange.ErrorState.insufficientNativeWalletBalance", value: "Insufficient %1$@ native wallet balance, you will need at least %1$@ to proceed.", comment: "Transaction error alert body")
            static let createTransferFailed = NSLocalizedString("Exchange.ErrorState.CreateTransferFailed", value: "Create transfer failed", comment: "Transaction error alert body")
            static let feeEstimateFailed = NSLocalizedString("Exchange.ErrorState.feeEstimateFailed", value: "Fee Estimate Failed", comment: "Transaction error alert body")
